...
ELF = os.environ.get("ELF", os.path.join(HERE, "saiapll.elf"))
...
#
#   AUDIO PLL = 24e6*(32+768/1000)/2 = 393.216 MHz; SAI1 root = AudioPll/16 -> MCLK 24.576e6
#   BCLK = MCLK / (2 * (TCR2[DIV] + 1)),  firmware writes DIV = 7     -> 1 536 000
#   rate = BCLK / (FRSZ+1 words * (W0W+1) bits) = 1536000 / (2 * 16)  ->  48 000
MCLK_HZ = 24_576_000
...
SWEEP = [7, 15]              # -> 48000 Hz and 24000 Hz off the 24.576 MHz Audio-PLL MCLK
